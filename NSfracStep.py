...
meshname = commandline_kwargs.get('meshname', 'circle_0')
meshdir = commandline_kwargs.get('meshdir', 'oasis/data221120/las')

global_variables.set_value('meshname', meshname)
global_variables.set_value('meshdir', meshdir)
...
while t < (T - tstep * DOLFIN_EPS) and not stop:
    ...
    # timeseries_p.store(q_['p'].vector(), t)
    # timeseries_u.store(q_['u0'].vector(), t)
